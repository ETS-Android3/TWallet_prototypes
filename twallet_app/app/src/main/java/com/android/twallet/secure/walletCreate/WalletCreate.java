package com.android.twallet.secure.walletCreate;
    ...
    public void doAsyncTask() {
        ...
        Runnable runnable = () -> {
            try {
                ...
                runOnUiThread(() -> Toast.makeText(WalletCreate.this, "Invalid Password", Toast.LENGTH_SHORT).show());
            } catch (InvalidAlgorithmParameterException | NoSuchAlgorithmException | NoSuchProviderException ignored) {
                runOnUiThread(() -> Toast.makeText(WalletCreate.this, "Internal Processing Error", Toast.LENGTH_SHORT).show());
